...
::: center
![Intersection of geo and non-geo changes of the municipalities](img/‎Untitled.‎001.png){#fig-1 width="100%" max-width="500px" alt="intersection"}
:::
...
::: center
![How we can understand the process of change: from causes to consequences.](img/‎Untitled.‎002.png){#fig-2 width="100%" max-width="500px" alt="merger diagram"}
:::
